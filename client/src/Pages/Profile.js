                ...
                <div className="container">
                    <Row>
                        <Col lg={2} sm={12} id="aside">
                            <Button variant="dark" id="active-sells" onClick={handleActive}>Produtos á venda</Button>{' '}
                            <Button variant="dark" id="archived-sells" onClick={handleArchived}>Arquivados</Button>{' '}
